...
// 
/*
Observamos que utilizar o garbage collector desacelerou
muito o programa. Ao criar vetores de tamanhos crescentes,
o tempo gasto com o coletor de lixo foi ficando cada vez maior,
ao passo que o tempo gasto sem o coletor de lixo (somente stdlib)
permaneceu quase constante (e bem menor).
*/
int main(){
	float *v;
	int tam, i, iter;
